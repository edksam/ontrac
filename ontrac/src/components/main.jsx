  ...
  return (
    <div id="container">
      ...
      <nav class="nav navbar-light bg-light" id="nav">
            <Link to="/" class="btn btn-outline-success btnSize">
              Home
            </Link>
...
function Main(prop){
    ...
    //API to extract all student records on main page load
    const [data,setData]=useState([]);
    useEffect(
        function(){
        const url=prop.url;
...
function AddNew(prop){
    ...
    const [gitHub,setGitHub]=useState(null);
    const [english,setEnglish]=useState("Excellent");
    const [languageSupport,setLanguageSupport]=useState("Yes");
    const [location,setLocation]=useState(null);
    const [className,setClassName]=useState(null);
    const addChange=Math.random(100);
        ...
        <div id="edit">
            <table class="table table-striped table-bordered" >
                ...
                <tbody>
                    <tr>
                        <td style={{fontSize:'1.4rem'}}>
                            <input value={document.getElementById(prop.editId).children[1].textContent} style={{width:'15rem'}} placeholder="Enter Name" type="text" name="txtName" id="txtName" onChange={function(e){setName(e.target.value)}} />
                        ...
                        <td style={{fontSize:'1.4rem'}}>
                            <input style={{width:'10rem'}} type="text" placeholder="Enter Edu Buddy" name="txtEdu" onChange={function(e){setEdu(e.target.value)}} />
                            {document.getElementById(prop.editId).children[3].textContent}
                        </td>
                        <td>
                            <input style={{width:'10rem'}} type="text" name="txtPD" placeholder="Enter PD Buddy" onChange={function(e){setPD(e.target.value)}} />
                            {document.getElementById(prop.editId).children[4].textContent}
                        </td>
                        <td style={{fontSize:'1.4rem'}}>
                            <input style={{width:'15rem'}} type="text" name="txtGitHub" placeholder="Enter GitHub ID" onChange={function(e){setGitHub(e.target.value) }} />
                            {document.getElementById(prop.editId).children[5].textContent}
                            </td>
                        <td style={{fontSize:'1.4rem'}}>
                            <select name="selectEnglishTest" onChange={function(e){setEnglish(e.target.value)}} >
                        ...
                        <td style={{fontSize:'1.4rem'}}>
                            <input style={{width:'10rem'}} placeholder="Enter Class" type="text" name="txtClassName" id="txtClassName"  onChange={function(e){setClassName(e.target.value)}} />
                        </td>
                        <td style={{fontSize:'1.4rem'}}>
                            <input style={{width:'10rem'}} placeholder="Enter Location" type="text" name="txtLocation" id="txtLocation" onChange={function(e){setLocation(e.target.value)}} />
                        </td>
                        <td>
...
>>>>>>> 45b289662d7eb76a96a33a6737ff26711cde07c0
    </footer>
  );
}
<<<<<<< HEAD
